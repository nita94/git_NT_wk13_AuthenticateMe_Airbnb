...
const validateSignup = [
    ...
    check('username').exists({ checkFalsy: true }).withMessage('Username must be unique'),
    check('username').exists({ checkFalsy: true }).isLength({ min: 4 }).withMessage('Username must be unique'),
